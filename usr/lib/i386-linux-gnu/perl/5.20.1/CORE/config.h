...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Sat Sep 20 13:43:35 UTC 2014
 * Configured by     : Debian Project
 * Target system     : linux callisto 3.2.0-4-686-pae #1 smp debian 3.2.60-1+deb7u3 i686 gnulinux 
 */
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/i386-linux-gnu/perl/5.20.1"		/**/
#define SITEARCH_EXP "/usr/local/lib/i386-linux-gnu/perl/5.20.1"		/**/
