...
cf_time='Sat Sep 20 13:43:35 UTC 2014'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg16='-Dsitearch=/usr/local/lib/i386-linux-gnu/perl/5.20.1'
...
installsitearch='/usr/local/lib/i386-linux-gnu/perl/5.20.1'
...
myuname='linux callisto 3.2.0-4-686-pae #1 smp debian 3.2.60-1+deb7u3 i686 gnulinux '
n='-n'
need_va_copy='undef'
...
sig_size='69'
signal_t='void'
sitearch='/usr/local/lib/i386-linux-gnu/perl/5.20.1'
